...
public class DBHelper extends SQLiteOpenHelper {
		...
		private static final String DATABASE_CREATE = "CREATE TABLE " + FOOD_TABLE +" ("
													...
													+ FoodColumn.LOCATION+" text,"
													+ FoodColumn.PRICE+" double,"
													+ FoodColumn.ASSESSMENT+" int,"
													+ FoodColumn.RECOMMENDATION+" text,"
													+ FoodColumn.BUSINESSHOURS+" text,"
													+ FoodColumn.REMARKS+" text);";
